...
export class RoleProductsDataSource extends DataSource<any> {
    ...
    constructor(
        ...
        super();
        this.filteredData =
            this.roleProductsService.productApiResponse.ProductList;
    }

    connect(): Observable<any[]> {
        const displayDataChanges = [
            this.roleProductsService.onProductsChanged,
        ...
        return merge(...displayDataChanges).pipe(
            map(() => {
                let data =
                    this.roleProductsService.productApiResponse.ProductList.slice();
...
export default RoleProductsDataSource;
